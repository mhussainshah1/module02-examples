package com.spring.professional.exam.tutorial.module02.question08.aspects;
...
public class HelloBeanAspect {
    ...
    public void afterReturningHelloBean(JoinPoint joinPoint, Object returnValue) {
        System.out.println("\n\nHelloBeanAspect::afterReturningHelloBean <- start"
                + "Join Point = " + joinPoint.getStaticPart().toLongString()
                + "Signature = " + joinPoint.getSignature()
                + "Args = " + Arrays.toString(joinPoint.getArgs())
                + "Kind = " + joinPoint.getKind()
                + "Return Value = " + returnValue
                + "HelloBeanAspect::afterReturningHelloBean <- stop\n\n");
    }
